<template>
	<div class="slide fade-in">
		...
		<div class="highlight-box">
			<h3>Key Takeaways</h3>
			<p>
				Every minute your users spend typing information that already exists in
				your systems is a minute stolen from actual productive work.
				<strong>Let's give them those minutes back.</strong>
			</p>
			<br />
			<p>
				Your database isn't just a storage system—it's a crystal ball that can
				predict what your users need before they even know they need it.
			</p>
		</div>
